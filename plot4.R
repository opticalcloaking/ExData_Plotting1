...
# open png device
imagefile <- "E:\\My Documents\\Github\\ExData_Plotting1\\plot4.png"
...
with(powerdf, plot(timedate, Global_active_power, type = "l", col = "black", 
                   xlab = xlabel, ylab = ylabel))

# top right
xlabel = "datetime"
ylabel = "Voltage"
with(powerdf, plot(timedate, Voltage, xlab = xlabel, ylab = ylabel, type = "l"))
...
with(powerdf, plot(timedate, Global_reactive_power, xlab = xlabel, 
                   ylab = ylabel, type = "l"))
